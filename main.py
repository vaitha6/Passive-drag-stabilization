...
axes[0].plot(timesteps*timestep, angular_velocity_history[:, 0], label='Omega X (rad/s)')
axes[0].plot(timesteps*timestep, angular_velocity_history[:, 1], label='Omega Y (rad/s)')
axes[0].plot(timesteps*timestep, angular_velocity_history[:, 2], label='Omega Z (rad/s)')
...
axes[1].plot(timesteps*timestep, angular_acceleration_history[:, 0], label='Alpha X (rad/s²)')
axes[1].plot(timesteps*timestep, angular_acceleration_history[:, 1], label='Alpha Y (rad/s²)')
axes[1].plot(timesteps*timestep, angular_acceleration_history[:, 2], label='Alpha Z (rad/s²)')
